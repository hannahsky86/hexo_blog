---
title: How to Build a Blog with Hexo, Heroku, and GraphComments
...
## 1. Build a Static Website with Hexo and Heroku 
...
Go to <strong>blog_example > public</strong>

Create a new file title <strong>index.php</strong> 
...
Follow the instructions on the Heroku page
...
Press any key to open the browser and login to Heroku

```
cd into blog_example/public 
heroku git:remote -a name-of-website
git add .
...
On the right side of the page, under <strong>Last activity</strong>, it should show "Build Succeeded" and "Deployed". If it doesn't show "Build Succeeded", make sure that <strong>index.php</strong> is under the <strong>public</strong> directory.
...
## 2. Add Comments to Your Static Website  
...
## 4. Change the Title and Subtitle 
...
## 5. Specify Number of Posts per Page 
...
## 6. Change the  Title and Subtitle Font Size
...
## 11. Fix "Next" and "Prev" if Broken 
...
## 12. Add Your Project to Your Repo 
...
<strong>To push to your Github repository, cd to "blog_example" and type </strong>
...
<strong>To push changes to Heroku and see changes on your webpage, cd to "public" and type </strong>
